...
map.getView().fit([13675164.403210, 30953.259564, 13773914.747614, 89854.843424], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA KESESUAIAN TUTUPAN LAHAN 2019 TERHADAP RTRW KABUPATEN BONE BOLANGO 2021-2041</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (930 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta Kesesuaian Penggunaan Lahan terhadap Rencana Tata Ruang Wilayah (RTRW) Kabupaten Bone Bolango Tahun 2026 disusun untuk menggambarkan tingkat kesesuaian antara kondisi penggunaan lahan eksisting dengan arahan pola ruang dalam RTRW Kabupaten Bone Bolango Tahun 2021-2041. Peta ini dihasilkan melalui analisis overlay (intersect) antara data penggunaan lahan tahun 2019 dan data RTRW menggunakan perangkat lunak Sistem Informasi Geografis (SIG). Hasil analisis diklasifikasikan ke dalam tiga kategori, yaitu Sesuai, Tidak Sesuai, dan Perlu Dikaji, sehingga dapat memberikan informasi spasial mengenai tingkat kesesuaian pemanfaatan ruang di wilayah studi. Peta ini diharapkan menjadi media pendukung dalam identifikasi potensi konflik pemanfaatan ruang, evaluasi implementasi RTRW, serta mendukung proses pengambilan keputusan dalam perencanaan tata ruang, governansi pertanahan, dan kebijakan agraria di Kabupaten Bone Bolango.';
            }
